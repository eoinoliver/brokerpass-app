...
const UNITS = [
  ...
  { code: "FNSFMB412", name: "Identify Client Needs & Present Options", icon: "🤝", free: false },
  { code: "FNSINC412", name: "Financial Products & Services Knowledge", icon: "🏦", free: false },
  { code: "FNSCRD401", name: "Assess Credit Applications", icon: "📊", free: false },
...
const SAMPLE_QUESTIONS = {
  "FNSFMK515": [
    ...
    { q: "Which Act governs the Best Interests Duty obligations for Australian mortgage brokers?", options: ["Corporations Act 2001", "ASIC Act 2001", "National Consumer Credit Protection Act 2009", "Financial Services Reform Act 2001"], answer: 2, explanation: "The Best Interests Duty is in Part 3-5A of the National Consumer Credit Protection Act 2009, introduced following Royal Commission recommendations." },
    { q: "A client has a recent credit default. Under your compliance obligations, you must first:", options: ["Decline and refer elsewhere", "Proceed only with non-conforming lenders", "Gather full information before assessing what assistance is in their best interests", "Notify ASIC before proceeding"], answer: 2, explanation: "Best Interests Duty requires comprehensive information gathering before any recommendation." },
  ],
  "FNSFMB411": [
    { q: "When preparing a loan application, which document captures the client's financial position, needs and objectives?", options: ["Credit Proposal Document", "Fact Find / Needs Analysis", "Privacy Consent Form", "Certificate of Title"], answer: 1, explanation: "The Fact Find captures income, expenses, assets, liabilities, and goals — the foundation of all recommendations." },
    { q: "Serviceability in a loan application refers to:", options: ["The property's condition", "The borrower's ability to meet repayment obligations", "The lender's customer service rating", "Whether the loan has offset features"], answer: 1, explanation: "Serviceability assesses whether a borrower can comfortably meet repayments." },
  ],
  "FNSINC412": [
    { q: "A client borrows $720,000 on a property worth $900,000. What is their LVR?", options: ["72%", "80%", "125%", "18%"], answer: 1, explanation: "LVR = (Loan / Property Value) x 100 = 80%. At 80% LVR the borrower typically avoids LMI." },
